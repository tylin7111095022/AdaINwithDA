...
def get_args():
    ...
    parser.add_argument('--weight', '-w', default=r'log\train45_in_dice_loss_mix_no_restore\teacher_5.pth', metavar='FILE',help='Specify the file in which the model is stored')
