...
def get_args():
    ...
    parser.add_argument('--weight', '-w', default=r'log\train17_adain_ASLandSL_fixencoder_pretrain_cropunet_instanceHead\unet_27.pth', metavar='FILE',help='Specify the file in which the model is stored')
